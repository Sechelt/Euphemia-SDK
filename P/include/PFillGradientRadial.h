#ifndef H_PFillGradientRadial
#define H_PFillGradientRadial
 ...
 */
class PFillGradientRadial : public PShapeBase
{
    Q_OBJECT
public:
    PFillGradientRadial( PCanvas *pCanvas );
    virtual ~PFillGradientRadial();
