#ifndef H_PFillGradientConical
#define H_PFillGradientConical
 ...
 */
class PFillGradientConical : public PShapeBase
{
    Q_OBJECT
public:
    PFillGradientConical( PCanvas *pCanvas );
    virtual ~PFillGradientConical();
