#ifndef H_PFillGradientPreset
#define H_PFillGradientPreset
 ...
 */
class PFillGradientPreset : public PShapeBase
{
    Q_OBJECT
public:
    PFillGradientPreset( PCanvas *pCanvas );
    virtual ~PFillGradientPreset();

    void setPreset( QGradient::Preset );
